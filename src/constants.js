  ...
  export const education = [
    {
      ...
      grade: "7.33 CGPA",
      desc: "I am currently pursuing my B.Tech in Electronics and Communication Engineering from Malaviya National Institute of Technology (MNIT), Jaipur. During my time at MNIT, I have built a strong foundation in engineering and programming, while sharpening my analytical and problem-solving skills. Participating in workshops, technical events, and project-based learning has significantly enhanced my practical understanding. This experience has played a vital role in shaping my professional and personal growth as an aspiring engineer.",
